    ...
    public Issues findIssues(String query, String accessToken, String secret) {
        ...
        for (BasicIssue basicIssue : searchJqlPromise.claim().getIssues()) {
            ...
            issues.add(com.appdirect.jira.vo.Issue.builder()
                    ...
                    .reporter(User.builder().name(null != issue.getReporter() ? issue.getReporter().getName() : null).displayName(issue.getReporter() != null ? issue.getReporter().getDisplayName() : null).build())
                    ...
                    .assignee(User.builder().name(null != issue.getAssignee() ? issue.getAssignee().getName(): null).displayName(null != issue.getAssignee() ? issue.getAssignee().getDisplayName(): null).build())
                    .priority(issue.getPriority().getName())
                    .createdDate(issue.getCreationDate() != null ? issue.getCreationDate().getMillis() : null)
                    .dueDate(issue.getDueDate() != null ? issue.getDueDate().getMillis() : null)
